...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{Abbildungen/Entwurfsmuster.pdf}
...
\noindent
Das erstellen einer Meldung (Objektes) erfolgt in der Methode CreateObject( ). Diese Methode ist in der GroupwareMailsToObjectFatory als abstrakte Methode definiert, wird der Klasse TicketHandler vererbt und hier auch explizit aufgerufen. Wichtig bei diese Methode ist die Übergabe einer Session. In GEBman10 benötigt jede Datenbankbearbeitung eine neue SessionTransaction.
%https://books.google.de/books?id=gnoeauhpC-cC&pg=PA103&hl=de#v=onepage&q&f=false
...
%http://link.springer.com/book/10.1007/978-3-658-09964-0
